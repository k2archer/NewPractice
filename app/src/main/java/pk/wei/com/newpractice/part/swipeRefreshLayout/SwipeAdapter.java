package pk.wei.com.newpractice.part.swipeRefreshLayout;
...
public class SwipeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public SwipeAdapter(List<String> data, Context context, boolean hasMore) {
        // 初始化变量
        this.datas = data;
    ...
    class NormalHolder extends RecyclerView.ViewHolder {
        ...
        public NormalHolder(View itemView) {
            super(itemView);
            textView = (TextView) itemView.findViewById(R.id.test_item_name);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.test_item, null));
        } else {
